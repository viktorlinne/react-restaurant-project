...
const Footer = () => {
    return (
        <div className={"bg-nav text-black mt-8"}>
            <div className={"flex flex-col md:flex-row justify-between items-start p-8 lg:px-32 px-5 gap-8"}>
                <div className={"w-full md:w-1/4 mt-4 text-center md:text-left"}>
                ...
                <div className={"w-full md:w-2/4 lg:w-2/5 mt-4"}>
                    <iframe
            ...
            <p className={"text-center font-medium mt-4 p-4"}>
                ...
                Rights Reserved {/* Lägg till länk till egen sida!!! */}
            </p>
        </div>
    );
};
